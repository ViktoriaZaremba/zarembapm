...
- The successful delivery led to continued collaboration on the project.`
        ...
        {
            meta: {
                title: "Designing a Decision-Making Framework for Company Branding",
                company: "Blackthorn.ai",
                summary: "Unblocked a stalled corporate website project by designing a structured decision-making framework with weighted voting, enabling stakeholders to align on branding decisions that remain in use today.",
                competencies: ["Decision Facilitation", "Stakeholder Alignment", "Process Design", "Governance", "Product Leadership", "Organizational Problem Solving", "Strategic Communication"],
                readingTime: "3 min",
                slug: "decision-making-framework-branding"
            },
            content: `## Context
...
- The structured decision-making approach eliminated repeated cycles of subjective discussions.`
        ...
        {
            meta: {
                title: "Building a Data-Driven Focus Factor Methodology",
                company: "GR8.Tech",
                summary: "Designed a reusable methodology for calculating Focus Factor from historical sprint data, replacing assumption-based planning with evidence-based delivery forecasting across multiple teams.",
                competencies: ["Delivery Forecasting", "Process Improvement", "Operational Excellence", "Data-informed Decision Making", "Capacity Planning", "Planning Methodology", "Knowledge Sharing"],
                readingTime: "3 min",
                slug: "data-driven-focus-factor"
            },
            content: `## Context
...
- Created a reusable planning approach that could be adopted by other teams without additional implementation effort.`
        ...
        {
            meta: {
                title: "Eliminating a Hardware Testing Bottleneck",
                company: "WeSoftYou",
                summary: "Removed a year-long delivery bottleneck by proposing hardware device transfer to the engineering team, enabling independent testing and significantly increasing development throughput.",
                competencies: ["Root Cause Analysis", "Process Improvement", "Stakeholder Management", "Delivery Optimization", "Dependency Management", "Cross-functional Collaboration"],
                readingTime: "2 min",
                slug: "eliminating-hardware-testing-bottleneck"
            },
            content: `## Context
...
- Created an opportunity to expand QA involvement and provide additional testing capacity for the client.`
        ...
        {
            meta: {
                title: "Improving SLA Compliance Through Process Optimization",
                company: "GR8.Tech",
                summary: "Increased SLA compliance from 60\u201380% to a sustained 90\u2013100% by redesigning incident notification processes, introducing proactive monitoring dashboards and establishing Root Cause Analysis reviews.",
                competencies: ["Operational Excellence", "Incident Management", "Process Improvement", "Service Delivery", "Root Cause Analysis", "KPI Management", "Continuous Improvement"],
                readingTime: "3 min",
                slug: "improving-sla-compliance"
            },
            content: `## Context
